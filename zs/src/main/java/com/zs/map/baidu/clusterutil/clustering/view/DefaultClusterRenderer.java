...
package com.zs.map.baidu.clusterutil.clustering.view;
...
import com.zs.R;
import com.zs.map.baidu.clusterutil.MarkerManager;
...
import com.zs.map.baidu.clusterutil.projection.Point;
import com.zs.map.baidu.clusterutil.projection.SphericalMercatorProjection;
import com.zs.map.baidu.clusterutil.ui.IconGenerator;
import com.zs.map.baidu.clusterutil.ui.SquareTextView;

import static com.zs.map.baidu.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
