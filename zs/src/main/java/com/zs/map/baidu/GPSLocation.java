        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            gnssListener = new GnssStatus.Callback() {
                ...
                public void onSatelliteStatusChanged(GnssStatus status) {
                   ...
                   System.out.println("GPSLocation GnssStatus  onSatelliteStatusChanged " + status.getSatelliteCount());
    ...
    public void startLocation(){
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                System.out.println("GPSLocation GPSLocation locationListener onLocationChanged" + location.getLatitude() + " " + location.getLongitude() + " " + location.getSpeed()
            ...
            public void onStatusChanged(String provider, int status, Bundle extras) {
                System.out.println("GPSLocation GPSLocation locationListener onStatusChanged" + status
                        + "" + provider);
            }

            @Override
            public void onProviderEnabled(String provider) {
                System.out.println("GPSLocation GPSLocation locationListener onProviderEnabled"
                        + "" + provider);
            }

            @Override
            public void onProviderDisabled(String provider) {
                System.out.println("GPSLocation GPSLocation locationListener onProviderDisabled"
                        + "" + provider);
            }
        };
