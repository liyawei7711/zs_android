...
import com.qrcode.scanner.util.__ScreenUtils;
...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        mCameraResolution = findCloselySize(__ScreenUtils.getScreenWidth(mContext), __ScreenUtils.getScreenHeight(mContext),
            parameters.getSupportedPreviewSizes());
        Log.e(TAG, "Setting preview size: " + mCameraResolution.width + "-" + mCameraResolution.height);
        mPictureResolution = findCloselySize(__ScreenUtils.getScreenWidth(mContext),
            __ScreenUtils.getScreenHeight(mContext), parameters.getSupportedPictureSizes());
